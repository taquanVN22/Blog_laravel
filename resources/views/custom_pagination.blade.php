<nav class="mt-4">
  ...
  <ul class="pagination justify-content-center">
      {{-- Previous Page Link --}}
      {{-- $paginator là đối tượng phân trang (paginator object), được sử dụng để quản lý danh sách các mục được phân trang --}}
      @if ($paginator->onFirstPage()){{--onFirstPage()kiểm tra xem đối tượng này có đang hiển thị trên trang đầu tiên hay không. --}}
