<div>
    ...
    <form class="card card-md" wire:submit.prevent="ForgotHandler" method="post" autocomplete="off" novalidate="">
        <div class="card-body">
          ...
          <p class="text-muted mb-4">Nhập địa chỉ email của bạn và mật khẩu sẽ được đặt lại và gửi qua email cho bạn.</p>
          <div class="mb-3">
            <label class="form-label">Email address</label>
            <input type="email" class="form-control" wire:model="email" placeholder="vui lòng nhập email">
          ...
          <div class="form-footer">
            <button href="#" class="btn btn-primary w-100" type="submit">
              ...
              Gửi cho tôi liên kết đặt lại mật khẩu
            </button>
          </div>
        </div>
      </form>
